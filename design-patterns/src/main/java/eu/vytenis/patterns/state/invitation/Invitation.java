...
import eu.vytenis.patterns.state.invitation.states.Accepted;
import eu.vytenis.patterns.state.invitation.states.Declined;
import eu.vytenis.patterns.state.invitation.states.Invited;
import eu.vytenis.patterns.state.invitation.states.NotInvited;
